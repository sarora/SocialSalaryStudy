...
# redefine column names
colnames(survey_results) <- c('consent', 'country', 'salary_base', 'salary_expect',
                              'no_increase_acceptance',
                              'living_expenses', 'savings', 'vacation', 'daily_leisure',
                              'consumption_goods',
...
survey_results_grouped <- survey_results_grouped %>% 
  mutate(continent = ifelse(country %in% c("United States of America (USA)", "Canada"), 
                                                                     'North America', 
                            ifelse(country %in% c("Botswana",  "Nigeria",  "South Africa"), 
                                   'Africa', NA)))
